...
const CategoryProduct = () => {
  ...
  return (
    <Layout>
      ...
      <div className="product-container container-fuild top-50 justify-content-center align-items-center ">
        <div className="row product-grid d-grid justify-content-center align-items-center">
          {products?.map((p) => (
